<template>
  <div class="flex-col justify-between" :style="{ height: '90%' }">
    <form  @submit.prevent="handleSubmit(logValues)">
      <div class="grid ml-0 mr-0 mt-0">
        <div class="col-12">
          <div class="p-fluid formgrid grid">
            <div class="field col-12 md:col-6">
              <Label text="Name" for="name" :required="true" />
              <InputText v-model="name"  id="name" type="text" autofocus />
      ...
      <div :style="{ background : 'white' , zIndex : 99,  bottom: '15px', right: '15px', position: 'absolute' }">
  ...
  setup() {
   ...
   const { value: name } = useField('name');
    ...
    const onSubmit = (values) => {
     ...
     // Function to log values, passed to handleSubmit
